...
with open('/Users/franciscoribeiro/OneDrive - University College London/YEAR 2 - Mansci/Data Analytics II/Scenario Week/Web App/merged_dataset.csv', 'r') as csv_file:
    data_reader = csv.reader(csv_file)
    next(data_reader, None)  # Skip header row
    category_6 = []
    for row in data_reader:
        if row[0] == '6':
            category_6.append(row[1:])
...
def four_image_gen():
    ...
    num_images = 4
    random_rows = random.sample(category_6, num_images)
